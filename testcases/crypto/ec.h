...
struct ED_TEST_VECTOR ed_tv[] = {
    ...
    {                           // #1 [Ed25519]
        ...
        .params = {0x06, 0x03, 0x2B, 0x65, 0x70},
        .params_len = 5,
        .privkey = {0x4c, 0xcd, 0x08, 0x9b, 0x28, 0xff, 0x96, 0xda,
                    0x9d, 0xb6, 0xc3, 0x46, 0xec, 0x11, 0x4e, 0x0f,
                    0x5b, 0x8a, 0x31, 0x9f, 0x35, 0xab, 0xa6, 0x24,
                    0xda, 0x8c, 0xf6, 0xed, 0x4f, 0xb8, 0xa6, 0xfb},
        .privkey_len = 32,
        .pubkey = {0x04, 0x20, 0x3d, 0x40, 0x17, 0xc3, 0xe8, 0x43,
                   0x89, 0x5a, 0x92, 0xb7, 0x0a, 0xa7, 0x4d, 0x1b,
                   0x7e, 0xbc, 0x9c, 0x98, 0x2c, 0xcf, 0x2e, 0xc4,
                   0x96, 0x8c, 0xc0, 0xcd, 0x55, 0xf1, 0x2a, 0xf4,
                   0x66, 0x0c},
        .pubkey_len = 34,
        .msg = {0x72},
        .msg_len = 1,
    ...
    {                           // #2 [Ed25519]
        ...
        .params = {0x06, 0x03, 0x2B, 0x65, 0x70},
        .params_len = 5,
        .privkey = {0xc5, 0xaa, 0x8d, 0xf4, 0x3f, 0x9f, 0x83, 0x7b,
                    0xed, 0xb7, 0x44, 0x2f, 0x31, 0xdc, 0xb7, 0xb1,
                    0x66, 0xd3, 0x85, 0x35, 0x07, 0x6f, 0x09, 0x4b,
                    0x85, 0xce, 0x3a, 0x2e, 0x0b, 0x44, 0x58, 0xf7},
        .privkey_len = 32,
        .pubkey = {0x04, 0x20, 0xfc, 0x51, 0xcd, 0x8e, 0x62, 0x18,
                   0xa1, 0xa3, 0x8d, 0xa4, 0x7e, 0xd0, 0x02, 0x30,
                   0xf0, 0x58, 0x08, 0x16, 0xed, 0x13, 0xba, 0x33,
                   0x03, 0xac, 0x5d, 0xeb, 0x91, 0x15, 0x48, 0x90,
                   0x80, 0x25},
        .pubkey_len = 34,
        .msg = {0xaf, 0x82},
        .msg_len = 2,
        ...
        .ctx_len = 0,
        .prehash = FALSE,
        .signature = {0x62, 0x91, 0xd6, 0x57, 0xde, 0xec, 0x24, 0x02,
    ...
    {                           // #3 [Ed25519]
        ...
        .params = {0x06, 0x03, 0x2B, 0x65, 0x70},
        .params_len = 5,
        .privkey = {0xf5, 0xe5, 0x76, 0x7c, 0xf1, 0x53, 0x31, 0x95,
                    0x17, 0x63, 0x0f, 0x22, 0x68, 0x76, 0xb8, 0x6c,
                    0x81, 0x60, 0xcc, 0x58, 0x3b, 0xc0, 0x13, 0x74,
                    0x4c, 0x6b, 0xf2, 0x55, 0xf5, 0xcc, 0x0e, 0xe5},
        .privkey_len = 32,
        .pubkey = {0x04, 0x20, 0x27, 0x81, 0x17, 0xfc, 0x14, 0x4c,
                   0x72, 0x34, 0x0f, 0x67, 0xd0, 0xf2, 0x31, 0x6e,
                   0x83, 0x86, 0xce, 0xff, 0xbf, 0x2b, 0x24, 0x28,
                   0xc9, 0xc5, 0x1f, 0xef, 0x7c, 0x59, 0x7f, 0x1d,
                   0x42, 0x6e},
        .pubkey_len = 34,
        .msg = {0x08, 0xb8, 0xb2, 0xb7, 0x33, 0x42, 0x42, 0x43,
        ...
        .ctx_len = 0,
        .prehash = FALSE,
        .signature = {0x0a, 0xab, 0x4c, 0x90, 0x05, 0x01, 0xb3, 0xe2,
    ...
    {                           // #4 [Ed25519]
        ...
        .params = {0x06, 0x03, 0x2B, 0x65, 0x70},
        .params_len = 5,
        .privkey = {0x83, 0x3f, 0xe6, 0x24, 0x09, 0x23, 0x7b, 0x9d,
                    0x62, 0xec, 0x77, 0x58, 0x75, 0x20, 0x91, 0x1e,
                    0x9a, 0x75, 0x9c, 0xec, 0x1d, 0x19, 0x75, 0x5b,
                    0x7d, 0xa9, 0x01, 0xb9, 0x6d, 0xca, 0x3d, 0x42},
        .privkey_len = 32,
        .pubkey = {0x04, 0x20, 0xec, 0x17, 0x2b, 0x93, 0xad, 0x5e,
                   0x56, 0x3b, 0xf4, 0x93, 0x2c, 0x70, 0xe1, 0x24,
                   0x50, 0x34, 0xc3, 0x54, 0x67, 0xef, 0x2e, 0xfd,
                   0x4d, 0x64, 0xeb, 0xf8, 0x19, 0x68, 0x34, 0x67,
                   0xe2, 0xbf},
        .pubkey_len = 34,
        .msg = {0xdd, 0xaf, 0x35, 0xa1, 0x93, 0x61, 0x7a, 0xba,
        ...
        .ctx_len = 0,
        .prehash = FALSE,
        .signature = {0xdc, 0x2a, 0x44, 0x59, 0xe7, 0x36, 0x96, 0x33,
    ...
    {                           // #5 [Ed25519ctx]
        ...
        .params = {0x06, 0x03, 0x2B, 0x65, 0x70},
        .params_len = 5,
        .privkey = {0x03, 0x05, 0x33, 0x4e, 0x38, 0x1a, 0xf7, 0x8f,
                    0x14, 0x1c, 0xb6, 0x66, 0xf6, 0x19, 0x9f, 0x57,
                    0xbc, 0x34, 0x95, 0x33, 0x5a, 0x25, 0x6a, 0x95,
                    0xbd, 0x2a, 0x55, 0xbf, 0x54, 0x66, 0x63, 0xf6},
        .privkey_len = 32,
        .pubkey = {0x04, 0x20, 0xdf, 0xc9, 0x42, 0x5e, 0x4f, 0x96,
                   0x8f, 0x7f, 0x0c, 0x29, 0xf0, 0x25, 0x9c, 0xf5,
                   0xf9, 0xae, 0xd6, 0x85, 0x1c, 0x2b, 0xb4, 0xad,
                   0x8b, 0xfb, 0x86, 0x0c, 0xfe, 0xe0, 0xab, 0x24,
                   0x82, 0x92},
        .pubkey_len = 34,
        .msg = {0xf7, 0x26, 0x93, 0x6d, 0x19, 0xc8, 0x00, 0x49,
    ...
    {                           // #6 [Ed25519ctx]
        ...
        .ctx_len = 3,
        .prehash = FALSE,
        .signature = {0xfc, 0x60, 0xd5, 0x87, 0x2f, 0xc4, 0x6b, 0x3a,
    ...
    {                           // #7 [Ed25519ctx]
        ...
        .pubkey = {0x04, 0x20, 0xdf, 0xc9, 0x42, 0x5e, 0x4f, 0x96,
                   ...
                   0x82, 0x92},
        .pubkey_len = 34,
        .msg = {0x50, 0x8e, 0x9e, 0x68, 0x82, 0xb9, 0x79, 0xfe,
        ...
        .ctx_len = 3,
        .prehash = FALSE,
        .signature = {0x8b, 0x70, 0xc1, 0xcc, 0x83, 0x10, 0xe1, 0xde,
    ...
    {                           // #8 [Ed25519ctx]
        ...
        .params = {0x06, 0x03, 0x2B, 0x65, 0x70},
        .params_len = 5,
        .privkey = {0xab, 0x9c, 0x28, 0x53, 0xce, 0x29, 0x7d, 0xda,
                    0xb8, 0x5c, 0x99, 0x3b, 0x3a, 0xe1, 0x4b, 0xca,
                    0xd3, 0x9b, 0x2c, 0x68, 0x2b, 0xea, 0xbc, 0x27,
                    0xd6, 0xd4, 0xeb, 0x20, 0x71, 0x1d, 0x65, 0x60},
        .privkey_len = 32,
        .pubkey = {0x04, 0x20, 0x0f, 0x1d, 0x12, 0x74, 0x94, 0x3b,
                   0x91, 0x41, 0x58, 0x89, 0x15, 0x2e, 0x89, 0x3d,
                   0x80, 0xe9, 0x32, 0x75, 0xa1, 0xfc, 0x0b, 0x65,
                   0xfd, 0x71, 0xb4, 0xb0, 0xdd, 0xa1, 0x0a, 0xd7,
                   0xd7, 0x72},
        .pubkey_len = 34,
        .msg = {0xf7, 0x26, 0x93, 0x6d, 0x19, 0xc8, 0x00, 0x49,
                0x4e, 0x3f, 0xda, 0xff, 0x20, 0xb2, 0x76, 0xa8},
        ...
        .ctx_len = 3,
        .prehash = FALSE,
        .signature = {0x21, 0x65, 0x5b, 0x5f, 0x1a, 0xa9, 0x65, 0x99,
    ...
    {                           // #10 [Ed448]
        ...
        .ctx_len = 0,
        .prehash = FALSE,
        .signature = {0x53, 0x3a, 0x37, 0xf6, 0xbb, 0xe4, 0x57, 0x25,
    ...
    {                           // #11 [Ed448]
        ...
        .params = {0x06, 0x03, 0x2B, 0x65, 0x71},
        .params_len = 5,
        .privkey = {0xc4, 0xea, 0xb0, 0x5d, 0x35, 0x70, 0x07, 0xc6,
                    ...
                    0x4e},
        .privkey_len = 57,
        .pubkey = { 0x04, 0x39, 0x43, 0xba, 0x28, 0xf4, 0x30, 0xcd,
                    0xff, 0x45, 0x6a, 0xe5, 0x31, 0x54, 0x5f, 0x7e,
                    0xcd, 0x0a, 0xc8, 0x34, 0xa5, 0x5d, 0x93, 0x58,
                    0xc0, 0x37, 0x2b, 0xfa, 0x0c, 0x6c, 0x67, 0x98,
                    0xc0, 0x86, 0x6a, 0xea, 0x01, 0xeb, 0x00, 0x74,
                    0x28, 0x02, 0xb8, 0x43, 0x8e, 0xa4, 0xcb, 0x82,
                    0x16, 0x9c, 0x23, 0x51, 0x60, 0x62, 0x7b, 0x4c,
                    0x3a, 0x94, 0x80},
        .pubkey_len = 59,
        .msg = {0x03},
        .msg_len = 1,
        ...
        .ctx_len = 0,
        .prehash = FALSE,
        .signature = {0x26, 0xb8, 0xf9, 0x17, 0x27, 0xbd, 0x62, 0x89,
    ...
    {                           // #12 [Ed448]
        ...
        .ctx_len = 3,
        .prehash = FALSE,
        .signature = {0xd4, 0xf8, 0xf6, 0x13, 0x17, 0x70, 0xdd, 0x46,
    ...
    {                           // #13 [Ed448]
        ...
        .params = {0x06, 0x03, 0x2B, 0x65, 0x71},
        .params_len = 5,
        .privkey = {0xcd, 0x23, 0xd2, 0x4f, 0x71, 0x42, 0x74, 0xe7,
                    ...
                    0x28},
        .privkey_len = 57,
        .pubkey = { 0x04, 0x39, 0xdc, 0xea, 0x9e, 0x78, 0xf3, 0x5a,
                    0x1b, 0xf3, 0x49, 0x9a, 0x83, 0x1b, 0x10, 0xb8,
                    0x6c, 0x90, 0xaa, 0xc0, 0x1c, 0xd8, 0x4b, 0x67,
                    0xa0, 0x10, 0x9b, 0x55, 0xa3, 0x6e, 0x93, 0x28,
                    0xb1, 0xe3, 0x65, 0xfc, 0xe1, 0x61, 0xd7, 0x1c,
                    0xe7, 0x13, 0x1a, 0x54, 0x3e, 0xa4, 0xcb, 0x5f,
                    0x7e, 0x9f, 0x1d, 0x8b, 0x00, 0x69, 0x64, 0x47,
                    0x00, 0x14, 0x00},
        .pubkey_len = 59,
        .msg = {0x0c, 0x3e, 0x54, 0x40, 0x74, 0xec, 0x63, 0xb0,
                0x26, 0x5e, 0x0c},
        .msg_len = 11,
        .mech_param = TRUE,
        .ctx_len = 0,
        .prehash = FALSE,
        .signature = {0x1f, 0x0a, 0x88, 0x88, 0xce, 0x25, 0xe8, 0xd4,
    ...
    {                           // #14 [Ed448]
        ...
        .params = {0x06, 0x03, 0x2B, 0x65, 0x71},
        .params_len = 5,
        .privkey = {0x87, 0x2d, 0x09, 0x37, 0x80, 0xf5, 0xd3, 0x73,
                    ...
                    0xe8},
        .privkey_len = 57,
        .pubkey = { 0x04, 0x39, 0xa8, 0x1b, 0x2e, 0x8a, 0x70, 0xa5,
                    0xac, 0x94, 0xff, 0xdb, 0xcc, 0x9b, 0xad, 0xfc,
                    0x3f, 0xeb, 0x08, 0x01, 0xf2, 0x58, 0x57, 0x8b,
                    0xb1, 0x14, 0xad, 0x44, 0xec, 0xe1, 0xec, 0x0e,
                    0x79, 0x9d, 0xa0, 0x8e, 0xff, 0xb8, 0x1c, 0x5d,
                    0x68, 0x5c, 0x0c, 0x56, 0xf6, 0x4e, 0xec, 0xae,
                    0xf8, 0xcd, 0xf1, 0x1c, 0xc3, 0x87, 0x37, 0x83,
                    0x8c, 0xf4, 0x00},
        .pubkey_len = 59,
        .msg = {0x6d, 0xdf, 0x80, 0x2e, 0x1a, 0xae, 0x49, 0x86,
        ...
        .ctx_len = 0,
        .prehash = FALSE,
        .signature = {0xe3, 0x01, 0x34, 0x5a, 0x41, 0xa3, 0x9a, 0x4d,
    ...
    {                           // #15 [Ed448ph]
        ...
        .privkey = {0x83, 0x3f, 0xe6, 0x24, 0x09, 0x23, 0x7b, 0x9d,
                    ...
                    0x49},
        .privkey_len = 57,
        .pubkey = { 0x04, 0x39, 0x25, 0x9b, 0x71, 0xc1, 0x9f, 0x83,
                    0xef, 0x77, 0xa7, 0xab, 0xd2, 0x65, 0x24, 0xcb,
                    0xdb, 0x31, 0x61, 0xb5, 0x90, 0xa4, 0x8f, 0x7d,
                    0x17, 0xde, 0x3e, 0xe0, 0xba, 0x9c, 0x52, 0xbe,
                    0xb7, 0x43, 0xc0, 0x94, 0x28, 0xa1, 0x31, 0xd6,
                    0xb1, 0xb5, 0x73, 0x03, 0xd9, 0x0d, 0x81, 0x32,
                    0xc2, 0x76, 0xd5, 0xed, 0x3d, 0x5d, 0x01, 0xc0,
                    0xf5, 0x38, 0x80},
        .pubkey_len = 59,
        .msg = {0x61, 0x62, 0x63},
        .msg_len = 3,
        ...
        .ctx_len = 0,
        .prehash = TRUE,
        .signature = {0x82, 0x2f, 0x69, 0x01, 0xf7, 0x48, 0x0f, 0x3d,
    ...
    {                           // #16 [Ed448ph]
        ...
        .ctx_len = 3,
        .prehash = TRUE,
        .signature = {0xc3, 0x22, 0x99, 0xd4, 0x6e, 0xc8, 0xff, 0x02,
...
#define ED_TV_NUM sizeof(ed_tv)/sizeof(struct ED_TEST_VECTOR)
...
struct ECDH_TEST_VECTOR montgomery_ecdh_tv[] = {
    {   // #0 [Curve25519]
        .name   = "Curve25519",
        .params = {0x06, 0x03, 0x2B, 0x65, 0x6E},
        .params_len = 5,
        .privkeyA = {0x77, 0x07, 0x6d, 0x0a, 0x73, 0x18, 0xa5, 0x7d,
                     0x3c, 0x16, 0xc1, 0x72, 0x51, 0xb2, 0x66, 0x45,
                     0xdf, 0x4c, 0x2f, 0x87, 0xeb, 0xc0, 0x99, 0x2a,
                     0xb1, 0x77, 0xfb, 0xa5, 0x1d, 0xb9, 0x2c, 0x2a},
        .pubkeyA =  {0x04, 0x20, 0x85, 0x20, 0xf0, 0x09, 0x89, 0x30,
                     0xa7, 0x54, 0x74, 0x8b, 0x7d, 0xdc, 0xb4, 0x3e,
                     0xf7, 0x5a, 0x0d, 0xbf, 0x3a, 0x0d, 0x26, 0x38,
                     0x1a, 0xf4, 0xeb, 0xa4, 0xa9, 0x8e, 0xaa, 0x9b,
                     0x4e, 0x6a},
        .privkeyB = {0x5d, 0xab, 0x08, 0x7e, 0x62, 0x4a, 0x8a, 0x4b,
                     0x79, 0xe1, 0x7f, 0x8b, 0x83, 0x80, 0x0e, 0xe6,
                     0x6f, 0x3b, 0xb1, 0x29, 0x26, 0x18, 0xb6, 0xfd,
                     0x1c, 0x2f, 0x8b, 0x27, 0xff, 0x88, 0xe0, 0xeb},
        .pubkeyB =  {0x04, 0x20, 0xde, 0x9e, 0xdb, 0x7d, 0x7b, 0x7d,
        ...
        .kdf = CKD_NULL,
        .shared_data_len = 0,
        .derived_key = {0x4a, 0x5d, 0x9d, 0x5b, 0xa4, 0xce, 0x2d, 0xe1,
    ...
    {   // #1 [Curve448]
        ...
        .params = {0x06, 0x03, 0x2B, 0x65, 0x6F},
        .params_len = 5,
        .privkeyA = {0x9a, 0x8f, 0x49, 0x25, 0xd1, 0x51, 0x9f, 0x57,
                     0x75, 0xcf, 0x46, 0xb0, 0x4b, 0x58, 0x00, 0xd4,
                     0xee, 0x9e, 0xe8, 0xba, 0xe8, 0xbc, 0x55, 0x65,
                     0xd4, 0x98, 0xc2, 0x8d, 0xd9, 0xc9, 0xba, 0xf5,
                     0x74, 0xa9, 0x41, 0x97, 0x44, 0x89, 0x73, 0x91,
        ...
        .pubkeyA =  {0x04, 0x38, 0x9b, 0x08, 0xf7, 0xcc, 0x31, 0xb7,
                     0xe3, 0xe6, 0x7d, 0x22, 0xd5, 0xae, 0xa1, 0x21,
                     0x07, 0x4a, 0x27, 0x3b, 0xd2, 0xb8, 0x3d, 0xe0,
                     0x9c, 0x63, 0xfa, 0xa7, 0x3d, 0x2c, 0x22, 0xc5,
                     0xd9, 0xbb, 0xc8, 0x36, 0x64, 0x72, 0x41, 0xd9,
                     ...
                     0x0d, 0x53, 0x17, 0x7f, 0x80, 0xe5, 0x32, 0xc4,
                     0x1f, 0xa0},
        .privkeyB = {0x1c, 0x30, 0x6a, 0x7a, 0xc2, 0xa0, 0xe2, 0xe0,
        ...
        .pubkeyB =  {0x04, 0x38, 0x3e, 0xb7, 0xa8, 0x29, 0xb0, 0xcd,
                     0x20, 0xf5, 0xbc, 0xfc, 0x0b, 0x59, 0x9b, 0x6f,
                     0xec, 0xcf, 0x6d, 0xa4, 0x62, 0x71, 0x07, 0xbd,
                     0xb0, 0xd4, 0xf3, 0x45, 0xb4, 0x30, 0x27, 0xd8,
                     0xb9, 0x72, 0xfc, 0x3e, 0x34, 0xfb, 0x42, 0x32,
                     0xa1, 0x3c, 0xa7, 0x06, 0xdc, 0xb5, 0x7a, 0xec,
                     0x3d, 0xae, 0x07, 0xbd, 0xc1, 0xc6, 0x7b, 0xf3,
                     0x36, 0x09},
        .privkey_len = 56,
        .pubkey_len = 58,
        .kdf = CKD_NULL,
        .shared_data_len = 0,
        .derived_key = {0x07, 0xff, 0xf4, 0x18, 0x1a, 0xc6, 0xcc, 0x95,
...
#define MONTGOMERY_ECDH_TV_NUM sizeof(montgomery_ecdh_tv)/sizeof(struct ECDH_TEST_VECTOR)
