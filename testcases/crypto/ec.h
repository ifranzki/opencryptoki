...
struct ED_TEST_VECTOR ed_tv[] = {
    {                           // #0 [Ed25519]
        ...
        .privkey = {0x9d, 0x61, 0xb1, 0x9d, 0xef, 0xfd, 0x5a, 0x60,
                    ...
                    0x70, 0x3b, 0xac, 0x03, 0x1c, 0xae, 0x7f, 0x60},
        .privkey_len = 32,
        .pubkey = {0xd7, 0x5a, 0x98, 0x01, 0x82, 0xb1, 0x0a, 0xb7,
    ...
    {                           // #1 [Ed25519]
        ...
        .privkey_len = 32,
        .pubkey = {0x3d, 0x40, 0x17, 0xc3, 0xe8, 0x43, 0x89, 0x5a,
    ...
    {                           // #2 [Ed25519]
        ...
        .privkey_len = 32,
        .pubkey = {0xfc, 0x51, 0xcd, 0x8e, 0x62, 0x18, 0xa1, 0xa3,
    ...
    {                           // #3 [Ed25519]
        ...
        .privkey_len = 32,
        .pubkey = {0x27, 0x81, 0x17, 0xfc, 0x14, 0x4c, 0x72, 0x34,
    ...
    {                           // #4 [Ed25519]
        ...
        .privkey_len = 32,
        .pubkey = {0xec, 0x17, 0x2b, 0x93, 0xad, 0x5e, 0x56, 0x3b,
    ...
    {                           // #5 [Ed25519ctx]
        ...
        .privkey_len = 32,
        .pubkey = {0xdf, 0xc9, 0x42, 0x5e, 0x4f, 0x96, 0x8f, 0x7f,
    ...
    {                           // #8 [Ed25519ctx]
        ...
        .privkey_len = 32,
        .pubkey = {0x0f, 0x1d, 0x12, 0x74, 0x94, 0x3b, 0x91, 0x41,
    ...
    {                           // #10 [Ed448]
        ...
        .privkey = {0x6c, 0x82, 0xa5, 0x62, 0xcb, 0x80, 0x8d, 0x10,
                    ...
                    0x5b},
        .privkey_len = 57,
        .pubkey = {0x5f, 0xd7, 0x44, 0x9b, 0x59, 0xb4, 0x61, 0xfd,
    ...
    {                           // #11 [Ed448]
        ...
        .privkey = {0xc4, 0xea, 0xb0, 0x5d, 0x35, 0x70, 0x07, 0xc6,
                    ...
                    0x4e},
        .privkey_len = 57,
        .pubkey = { 0x43, 0xba, 0x28, 0xf4, 0x30, 0xcd, 0xff, 0x45,
    ...
    {                           // #13 [Ed448]
        ...
        .privkey = {0xcd, 0x23, 0xd2, 0x4f, 0x71, 0x42, 0x74, 0xe7,
                    ...
                    0x28},
        .privkey_len = 57,
        .pubkey = { 0xdc, 0xea, 0x9e, 0x78, 0xf3, 0x5a, 0x1b, 0xf3,
    ...
    {                           // #14 [Ed448]
        ...
        .privkey = {0x87, 0x2d, 0x09, 0x37, 0x80, 0xf5, 0xd3, 0x73,
                    ...
                    0xe8},
        .privkey_len = 57,
        .pubkey = { 0xa8, 0x1b, 0x2e, 0x8a, 0x70, 0xa5, 0xac, 0x94,
    ...
    {                           // #15 [Ed448ph]
        ...
        .privkey = {0x83, 0x3f, 0xe6, 0x24, 0x09, 0x23, 0x7b, 0x9d,
                    ...
                    0x49},
        .privkey_len = 57,
        .pubkey = { 0x25, 0x9b, 0x71, 0xc1, 0x9f, 0x83, 0xef, 0x77,
...
struct ECDH_TEST_VECTOR montgomery_ecdh_tv[] = {
    {   // #0 [Curve25519]
        ...
        .privkeyA = {0x77, 0x07, 0x6d, 0x0a, 0x73, 0x18, 0xa5, 0x7d,
                     ...
                     0xdf, 0x4c, 0x2f, 0x87, 0xeb, 0xc0, 0x99, 0x2a,
                     0xb1, 0x77, 0xfb, 0xa5, 0x1d, 0xb9, 0x2c, 0x2a},
        .pubkeyA =  {0x85, 0x20, 0xf0, 0x09, 0x89, 0x30, 0xa7, 0x54,
        ...
        .pubkeyB =  {0xde, 0x9e, 0xdb, 0x7d, 0x7b, 0x7d, 0xc1, 0xb4,
    ...
    {   // #1 [Curve448]
        ...
        .pubkeyA =  {0x9b, 0x08, 0xf7, 0xcc, 0x31, 0xb7, 0xe3, 0xe6,
        ...
        .pubkeyB =  {0x3e, 0xb7, 0xa8, 0x29, 0xb0, 0xcd, 0x20, 0xf5,
