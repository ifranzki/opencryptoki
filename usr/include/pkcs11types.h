...
typedef CK_ULONG CK_IBM_CCA_AES_KEY_MODE_TYPE;
...
#define CKA_IBM_DILITHIUM_RHO     CKA_IBM_ML_DSA_RHO
#define CKA_IBM_DILITHIUM_SEED    CKA_IBM_ML_DSA_SEED
#define CKA_IBM_DILITHIUM_TR      CKA_IBM_ML_DSA_TR
#define CKA_IBM_DILITHIUM_S1      CKA_IBM_ML_DSA_S1
#define CKA_IBM_DILITHIUM_S2      CKA_IBM_ML_DSA_S2
#define CKA_IBM_DILITHIUM_T0      CKA_IBM_ML_DSA_T0
#define CKA_IBM_DILITHIUM_T1      CKA_IBM_ML_DSA_T1

#define CKA_IBM_KYBER_MODE        (CKA_VENDOR_DEFINED + 0x0000E)

#define CKA_IBM_KYBER_KEYFORM     (CKA_VENDOR_DEFINED + 0xd0009)
#define CKA_IBM_KYBER_PK          CKA_IBM_ML_KEM_PK
#define CKA_IBM_KYBER_SK          CKA_IBM_ML_KEM_SK

#define CK_IBM_KYBER_KEYFORM_ROUND2_768    1
#define CK_IBM_KYBER_KEYFORM_ROUND2_1024   2

/* Map the IBM Kyber param definitions to IBM_ML-KEM param definitions */
#define CK_IBM_KYBER_KEM_VERSION      0
#define CK_IBM_KYBER_KEM_MODE         CK_IBM_ML_KEM_MODE
#define CK_IBM_KYBER_KEM_ENCAPSULATE  CK_IBM_ML_KEM_ENCAPSULATE
#define CK_IBM_KYBER_KEM_DECAPSULATE  CK_IBM_ML_KEM_DECAPSULATE
#define CK_IBM_KYBER_KDF_TYPE         CK_IBM_ML_KEM_KDF_TYPE
#define CK_IBM_KYBER_PARAMS           CK_IBM_ML_KEM_PARAMS
...
#define CKA_IBM_ML_DSA_RHO              (CKA_VENDOR_DEFINED + 0xd0002)
#define CKA_IBM_ML_DSA_SEED             (CKA_VENDOR_DEFINED + 0xd0003)
#define CKA_IBM_ML_DSA_TR               (CKA_VENDOR_DEFINED + 0xd0004)
#define CKA_IBM_ML_DSA_S1               (CKA_VENDOR_DEFINED + 0xd0005)
#define CKA_IBM_ML_DSA_S2               (CKA_VENDOR_DEFINED + 0xd0006)
#define CKA_IBM_ML_DSA_T0               (CKA_VENDOR_DEFINED + 0xd0007)
#define CKA_IBM_ML_DSA_T1               (CKA_VENDOR_DEFINED + 0xd0008)
#define CKA_IBM_ML_DSA_PRIVATE_SEED     (CKA_VENDOR_DEFINED + 0xd000D)

#define CKA_IBM_ML_KEM_PK               (CKA_VENDOR_DEFINED + 0xd000A)
#define CKA_IBM_ML_KEM_SK               (CKA_VENDOR_DEFINED + 0xd000B)
#define CKA_IBM_ML_KEM_PRIVATE_SEED     (CKA_VENDOR_DEFINED + 0xd000C)
...
#define CKH_IBM_HEDGE_PREFERRED         1
#define CKH_IBM_HEDGE_REQUIRED          2
#define CKH_IBM_DETERMINISTIC_REQUIRED  3
...
#define CK_IBM_ML_KEM_VERSION           0

typedef CK_ULONG CK_IBM_ML_KEM_MODE;

#define CK_IBM_ML_KEM_ENCAPSULATE       1
#define CK_IBM_ML_KEM_DECAPSULATE       2

typedef CK_ULONG CK_IBM_ML_KEM_KDF_TYPE;
...
/* The following are new for v3.0 (aliases are new for v3.1) */
#define CKM_SHA3_256_KEY_DERIVATION    0x00000397
#define CKM_SHA3_224_KEY_DERIVATION    0x00000398
#define CKM_SHA3_384_KEY_DERIVATION    0x00000399
#define CKM_SHA3_512_KEY_DERIVATION    0x0000039A
#define CKM_SHAKE_128_KEY_DERIVATION   0x0000039B
#define CKM_SHAKE_256_KEY_DERIVATION   0x0000039C
...
#define CKM_ECDH_X_AES_KEY_WRAP        0x00004038
#define CKM_ECDH_COF_AES_KEY_WRAP      0x00004039

#define CKM_PUB_KEY_FROM_PRIV_KEY      0x0000403A
...
#define CKM_IBM_EC_AGGREGATE           CKM_VENDOR_DEFINED + 0x00010034
#define CKM_IBM_ML_DSA_KEY_PAIR_GEN    CKM_VENDOR_DEFINED + 0x00010035
#define CKM_IBM_ML_DSA                 CKM_VENDOR_DEFINED + 0x00010036
#define CKM_IBM_ML_KEM_KEY_PAIR_GEN    CKM_VENDOR_DEFINED + 0x00010037
#define CKM_IBM_ML_KEM                 CKM_VENDOR_DEFINED + 0x00010038
...
#define CK_IBM_BLS_MAX_AGGREGATIONS         12

typedef struct CK_IBM_ECDSA_OTHER_BLS_PARAMS {
    CK_ULONG numElements;
    CK_VOID_PTR pAggrElements[CK_IBM_BLS_MAX_AGGREGATIONS];
