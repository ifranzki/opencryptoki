...
static const MECH_LIST_ELEMENT icsf_mech_list[] = {
  ...
  /*  {CKM_SHA3_224_HMAC, {0, 0, CKF_HW | CKF_SIGN | CKF_VERIFY}}, */
    {CKM_SHA3_256, {0, 0, CKF_HW | CKF_DIGEST}},
  /*  {CKM_SHA3_256_HMAC, {0, 0, CKF_HW | CKF_SIGN | CKF_VERIFY}}, */
    {CKM_SHA3_384, {0, 0, CKF_HW | CKF_DIGEST}},
  /*  {CKM_SHA3_384_HMAC, {0, 0, CKF_HW | CKF_SIGN | CKF_VERIFY}}, */
    {CKM_SHA3_512, {0, 0, CKF_HW | CKF_DIGEST}},
  /*  {CKM_SHA3_512_HMAC, {0, 0, CKF_HW | CKF_SIGN | CKF_VERIFY}}, */
    ...
    {CKM_EC_KEY_PAIR_GEN,
     {160, 521, CKF_HW | CKF_GENERATE_KEY_PAIR | CKF_EC_F_P |
      CKF_EC_OID | CKF_EC_UNCOMPRESS}},
    {CKM_ECDH1_DERIVE,
       {160, 521, CKF_HW | CKF_DERIVE | CKF_EC_OID |
                         ...
                         CK_OBJECT_HANDLE_PTR p_key)
{
    ...
    case CKM_RSA_PKCS:
        ...
        if (cls_attr != NULL &&
            *((CK_ULONG *) cls_attr->pValue) != CKO_SECRET_KEY) {
