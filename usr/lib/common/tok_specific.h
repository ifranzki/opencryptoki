...
CK_RV token_specific_ecdh_pkcs_derive_kdf(STDLL_TokData_t *, SESSION *,
                                          OBJECT *,
...
CK_RV token_specific_ibm_ml_dsa_generate_keypair(STDLL_TokData_t *,
                                                 CK_MECHANISM *mech,
                                                 const struct pqc_oid *,
                                                 TEMPLATE *, TEMPLATE *);

CK_RV token_specific_ibm_ml_dsa_sign(STDLL_TokData_t *, SESSION *, CK_BBOOL,
                                     const struct pqc_oid *, CK_MECHANISM *,
                                     CK_BYTE *, CK_ULONG,
                                     CK_BYTE *, CK_ULONG *, OBJECT *);

CK_RV token_specific_ibm_ml_dsa_verify(STDLL_TokData_t *, SESSION *,
                                       const struct pqc_oid *, CK_MECHANISM *,
                                       CK_BYTE *, CK_ULONG,
                                       CK_BYTE *, CK_ULONG, OBJECT *);
...
CK_RV token_specific_ml_dsa_generate_keypair(STDLL_TokData_t *,
                                             const struct pqc_oid *,
                                             TEMPLATE *, TEMPLATE *);

CK_RV token_specific_ml_dsa_sign(STDLL_TokData_t *, SESSION *, CK_BBOOL,
                                 const struct pqc_oid *, CK_MECHANISM *,
                                 CK_BYTE *, CK_ULONG,
                                 CK_BYTE *, CK_ULONG *, OBJECT *);

CK_RV token_specific_ml_dsa_verify(STDLL_TokData_t *, SESSION *,
                                   const struct pqc_oid *, CK_MECHANISM *,
                                   CK_BYTE *, CK_ULONG,
                                   CK_BYTE *, CK_ULONG, OBJECT *);

CK_RV token_specific_ml_kem_generate_keypair(STDLL_TokData_t *,
                                             const struct pqc_oid *,
                                             TEMPLATE *, TEMPLATE *);
...
CK_RV token_specific_encapsulate_dh_ecdh_key_pair_gen(STDLL_TokData_t *,
                                                      SESSION *,
                                                      CK_MECHANISM *,
                                                      CK_ATTRIBUTE *, CK_ULONG,
                                                      CK_ATTRIBUTE *, CK_ULONG,
...
CK_RV token_specific_en_decapsulate_dh_ecdh_derive_key(STDLL_TokData_t *,
                                                       SESSION *,
                                                       CK_MECHANISM *,
