...
CK_RV token_specific_encapsulate_key(STDLL_TokData_t *, SESSION *, CK_BBOOL,
                                     CK_MECHANISM *, OBJECT *, CK_ATTRIBUTE *,
                                     CK_ULONG , CK_BYTE *, CK_ULONG *,
                                     CK_OBJECT_HANDLE *);

CK_RV token_specific_decapsulate_key(STDLL_TokData_t *, SESSION *,
                                     CK_MECHANISM *, OBJECT *, CK_ATTRIBUTE *,
                                     CK_ULONG, CK_BYTE *, CK_ULONG,
                                     CK_OBJECT_HANDLE *);
