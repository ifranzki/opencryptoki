                          ...
                          CK_OBJECT_HANDLE *phKey)
{
    ...
    * secret key is generated in the C_EncapsulateKey function and then wrapped
    * with RSA PKCS/OAEP.
    */
                          ...
                          CK_OBJECT_HANDLE *phKey)
{
    ...
    /*
     * PKCS#11 v3.2: C_DecapsulateKey is exactly equivalent to C_UnwrapKey for
     * RSA PKCS/OAEP.
     */
