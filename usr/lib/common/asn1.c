                              ...
                              CK_ATTRIBUTE **t1_attr)
{
    ...
    rc = ber_decode_SPKI(data, data_len, &algid, &algid_len,
    ...
    rc = ber_decode_SEQUENCE((CK_BYTE *)ber_AlgIdDilithium, ber_AlgIdDilithiumLen,
                             &algid_DilithiumBase, &len, &field_len);
    if (rc != CKR_OK) {
        TRACE_DEVEL("ber_decode_SEQUENCE failed\n");
        return rc;
    }
                               ...
                               CK_ATTRIBUTE **t1)
{
    ...
    CK_BYTE *buf = NULL;
    CK_BYTE *tmp = NULL;
    CK_ULONG offset, buf_len, field_len, len, dilithium_priv_key_len;
    CK_RV rc;
