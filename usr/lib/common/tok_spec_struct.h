...
struct token_specific_struct {
    ...
    /* Token specific shake key derive */
    CK_RV (*t_shake_key_derive) (STDLL_TokData_t *, SESSION *, CK_MECHANISM *,
                                 OBJECT *, CK_KEY_TYPE,
    ...
    CK_RV (*t_ibm_ml_kem_generate_keypair)(STDLL_TokData_t *,
                                           CK_MECHANISM *mech,
                                           const struct pqc_oid *,
                                           TEMPLATE *, TEMPLATE *);

    CK_RV (*t_ibm_ml_kem_derive)(STDLL_TokData_t *, SESSION *,
                                 const struct pqc_oid *, CK_MECHANISM *,
    ...
    CK_RV(*t_encapsulate_key)(STDLL_TokData_t *, SESSION *, CK_BBOOL,
                              CK_MECHANISM *, OBJECT *, CK_ATTRIBUTE *,
                              CK_ULONG , CK_BYTE *, CK_ULONG *,
                              CK_OBJECT_HANDLE *);

    CK_RV(*t_decapsulate_key)(STDLL_TokData_t *, SESSION *, CK_MECHANISM *,
                              OBJECT *, CK_ATTRIBUTE *, CK_ULONG, CK_BYTE *,
