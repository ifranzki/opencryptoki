...
token_spec_t token_specific = {
    ...
    &token_specific_ec_edwards_sign,
    &token_specific_ec_edwards_verify,
    &token_specific_ec_generate_keypair,
    &token_specific_ec_edwards_generate_keypair,
    &token_specific_ec_montgomery_generate_keypair,
...
/* End code contributed by Corrent corp. */
    ...
    &token_specific_ibm_ml_dsa_generate_keypair,
    &token_specific_ibm_ml_dsa_sign,
