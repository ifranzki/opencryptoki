...
#define P11KMIP_KMIP_TO_P11_ALG_TABLE_LENGTH      13
#define P11KMIP_P11_TO_KMIP_ALG_TABLE_LENGTH      32

const CK_KEY_TYPE P11KMIP_KMIP_TO_P11_ALG_TABLE[13] = {
    CKK_DES,
    CKK_DES3,
    CKK_AES,
    CKK_RSA,
...
const enum kmip_crypto_algo P11KMIP_P11_TO_KMIP_ALG_TABLE[32] = {
...
// 
const CK_OBJECT_CLASS P11KMIP_KMIP_TO_P11_OBJ_TABLE[10] = {
...
const enum kmip_object_type P11KMIP_P11_TO_KMIP_OBJ_TABLE[10] = {
