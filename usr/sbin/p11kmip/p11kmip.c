...
static CK_OBJECT_CLASS get_p11_obj_class_from_kmip(enum kmip_object_type
                                                   kmip_obj)
{
...
static enum kmip_object_type get_kmip_obj_class_from_p11(CK_OBJECT_CLASS
                                                         p11_obj)
{
...
static CK_MECHANISM_TYPE get_p11_hash_mech_from_kmip_hash_algo(enum
                                                               kmip_hashing_algo
                                                               kmip_hash_alg)
{
...
static enum kmip_crypto_usage_mask get_kmip_usage_mask_p11(struct
                                                           p11kmip_keytype
                                                           *keytype)
{
